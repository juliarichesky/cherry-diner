  ...
  return (
    <div className="mt-40 mb-20 relative px-4 italic">
      ...
      <div className="relative border-t-[6px] border-[#ca4952] border-x-1 border-b-1 border-x-[#e9dcc9] border-b-[#e9dcc9] rounded-b-[1.5rem] md:rounded-tr-[1.5rem] p-6 md:p-16 pt-16 shadow-[0_25px_80px_-20px_rgba(0,0,0,0.15)] bg-[#fdfaf5] overflow-hidden -mt-[1px]">
        {/* background de cerejas - aria-hidden esconde elementos decorativos */}
        <div
        ...
        {/* grid de comandas organizado semanticamente em uma lista (ul) */}
        <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 relative z-10 list-none p-0">
          {factsData.map((fact, index) => (
            <li key={fact.id}>
              ...
              >
                ...
                <header className="flex justify-between items-end border-b border-[#3d5a5a]/20 pb-2 mb-6">
                  ...
                  <div
                    className="p-1.5 bg-[#ca4952]/5 rounded-full text-[#ca4952]"
                    aria-hidden="true"
                  >
                ...
                <div className="relative min-h-[140px] flex flex-col">
                  {/* Linhas decorativas azuis - aria-hidden para acessibilidade */}
                  <div
                    className="absolute inset-0 flex flex-col justify-between py-1 pointer-events-none opacity-30"
                    aria-hidden="true"
                  >
                    {[...Array(6)].map((_, i) => (
                ...
                <footer className="mt-8 pt-4 border-t border-dashed border-[#3d5a5a]/10 flex flex-col items-center">
                  <div
                    className="w-full flex justify-between text-[8px] font-black text-[#3d5a5a]/30 uppercase mb-4"
                    aria-hidden="true"
                  >
                    <span>julias & co.</span>
