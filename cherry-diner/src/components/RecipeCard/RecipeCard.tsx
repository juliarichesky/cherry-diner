  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[4/5] overflow-hidden rounded-xl bg-[#f9f4ef]">
        {/* a imagem é buscada no objeto recipeimages usando o id da receita como chave */}
        <img
      ...
      <div className="mt-6 text-center">
        ...
        {/* descrição dinâmica com fallback para evitar espaços vazios caso o json não tenha o campo */}
        ...
        <div className="mt-6 pt-4 border-t border-dashed border-[#e5dcd3] flex items-center justify-around">
          {/* coluna de preparo */}
          ...
          <div className="w-[1px] h-6 bg-[#e5dcd3]"></div>
      ...
      {/* selo decorativo (stamp) que surge com efeito de rotação no hover da classe group */}
      <div className="absolute -bottom-2 -right-2 w-12 h-12 bg-[#ca4952] rounded-full flex items-center justify-center text-white text-[9px] font-black uppercase rotate-12 opacity-0 group-hover:opacity-100 transition-opacity duration-300 shadow-lg border-2 border-white">
